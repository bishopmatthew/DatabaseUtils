...
/** Abstract class used to represent a row in a table. Has CRUD methods, as well as the ability to load parent & child objects **/
public abstract class HierarchicalSqlObject implements Serializable {
	...
	protected String PARENT_ID = "parentId";
	...
	// CONSTANTS
	private static final String TAG = HierarchicalSqlObject.class.getSimpleName();
...
//		DbInterface db = DbInterface.getInstance();
	...
	/**
	 * Should load the parent object (if it exists)
	 **/
	...
	/** Load children objects into an arraylist**/
	public boolean loadChildren() {
		// TODO how to handle that there might be more than one "child" table
		return false;
	}

	/** Used to determine how to load parent **/
	public Class getParentType() {
		return null;
	}

	/** Used to determine how to load children **/
